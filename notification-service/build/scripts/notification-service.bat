...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %NOTIFICATION_SERVICE_OPTS%  -classpath "%CLASSPATH%" com.example.notification.NotificationApplication %*
...
if not ""=="%NOTIFICATION_SERVICE_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
